...
function hygiea_load_scripts() {
	...
	wp_enqueue_style( 'hygiea-main', get_template_directory_uri() . '/assets/css/main.css', false, '1.0.0', 'all' );
	wp_enqueue_style( 'hygiea', get_template_directory_uri() . '/assets/css/hygiea.css', false, '1.0.0', 'all' );

	wp_enqueue_script( 'hygiea-custom', get_template_directory_uri() . '/assets/js/_custom.js', array('jquery'), null, true ); // TODO min
}
